...
class VolumeLayerStyleWidget(QtGui.QWidget):
    ...
    def __init__(self, layer_artist):
        ...
        self.limits = AttributeLimitsHelper(attribute_combo=self.ui.combo_attribute,
                                            lower_value=self.ui.value_min,
                                            upper_value=self.ui.value_max,
                                            mode_combo=self.ui.combo_scale_mode,
                                            flip_button=self.ui.button_flip)
    ...
    def _update_subset_mode(self):
        if self.ui.radio_subset_outline.isChecked():
            ...
            self.limits.subset_mode = 'outline'
        else:
            self.layer_artist.subset_mode = 'data'
            self.limits.subset_mode = 'data'
